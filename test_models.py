...
def test_join(simple_user_join, filter_user_join):
    result1 = '''SELECT cmp1."Id" as "Id", cmp1."Data_Name" as "Name", cmp1."Data_Email" as "Email", cmp1."Data_Account" as "Account", cmp1."Data_IsActive" as "IsActive", cmp1."Data_Inviter" as "Inviter", cmp1."Data_Age" as "Age", cmp1."Data_Shares" as "Shares", cmp2."Id" as "cmp2_Id", cmp2."Data_Bonuses" as "Bonuses", cmp2."Data_IsActual" as "IsActual", cmp2."Data_MainAccount" as "MainAccount", cmp2."Data_PremiumAccount" as "PremiumAccount", cmp2."Data_PromotionalAccount" as "PromotionalAccount", cmp3."Id" as "cmp3_Id", cmp3."Data_SharesCount" as "SharesCount" FROM "user_table" as cmp1 INNER JOIN "account_table" as cmp2 ON cmp1."Data_Account" = cmp2."Id" INNER JOIN "shares_table" as cmp3 ON cmp1."Data_Shares" = cmp3."Id" WHERE cmp1."IsDelMark" = false AND cmp2."IsDelMark" = false AND cmp3."IsDelMark" = false '''
    assert simple_user_join.get_sql() == result1

    result2 = '''SELECT cmp1."Id" as "Id", cmp1."Data_Name" as "Name", cmp2."Id" as "cmp2_Id", cmp2."Data_Bonuses" as "Bonuses", cmp2."Data_IsActual" as "IsActual", cmp2."Data_MainAccount" as "MainAccount", cmp2."Data_PremiumAccount" as "PremiumAccount", cmp2."Data_PromotionalAccount" as "PromotionalAccount", cmp3."Id" as "cmp3_Id", cmp3."Data_SharesCount" as "SharesCount" FROM "user_table" as cmp1 INNER JOIN "account_table" as cmp2 ON cmp1."Data_Account" = cmp2."Id" INNER JOIN "shares_table" as cmp3 ON cmp1."Data_Shares" = cmp3."Id" WHERE cmp1."IsDelMark" = false AND cmp2."IsDelMark" = false AND cmp3."IsDelMark" = false '''
    assert simple_user_join.only("Id", "Name").get_sql() == result2

    result3 = '''SELECT cmp1."Id" as "Id", cmp1."Data_Name" as "Name", cmp2."Data_Bonuses" as "Bonuses", cmp3."Id" as "cmp3_Id", cmp3."Data_SharesCount" as "SharesCount" FROM "user_table" as cmp1 INNER JOIN "account_table" as cmp2 ON cmp1."Data_Account" = cmp2."Id" INNER JOIN "shares_table" as cmp3 ON cmp1."Data_Shares" = cmp3."Id" WHERE cmp1."IsDelMark" = false AND cmp2."IsDelMark" = false AND cmp3."IsDelMark" = false '''
    assert simple_user_join.only(("Id", "Name"), ("Bonuses",)).get_sql() == result3

    result4 = '''SELECT cmp1."Id" as "Id", cmp1."Data_Name" as "Name", cmp1."Data_Email" as "Email", cmp1."Data_Account" as "Account", cmp1."Data_IsActive" as "IsActive", cmp1."Data_Inviter" as "Inviter", cmp1."Data_Age" as "Age", cmp1."Data_Shares" as "Shares", cmp2."Id" as "cmp2_Id", cmp2."Data_Bonuses" as "Bonuses", cmp2."Data_IsActual" as "IsActual", cmp2."Data_MainAccount" as "MainAccount", cmp2."Data_PremiumAccount" as "PremiumAccount", cmp2."Data_PromotionalAccount" as "PromotionalAccount", cmp3."Id" as "cmp3_Id", cmp3."Data_SharesCount" as "SharesCount" FROM "user_table" as cmp1 INNER JOIN "account_table" as cmp2 ON cmp1."Data_Account" = cmp2."Id" INNER JOIN "shares_table" as cmp3 ON cmp1."Data_Shares" = cmp3."Id" WHERE cmp1."Data_Name" = 'Alex' AND cmp1."IsDelMark" = false AND cmp2."IsDelMark" = false AND cmp3."IsDelMark" = false '''
    ...
    result6 = '''SELECT cmp1."Id" as "Id", cmp1."Data_Name" as "Name", cmp2."Data_Bonuses" as "Bonuses", cmp3."Id" as "cmp3_Id", cmp3."Data_SharesCount" as "SharesCount" FROM "user_table" as cmp1 INNER JOIN "account_table" as cmp2 ON cmp1."Data_Account" = cmp2."Id" INNER JOIN "shares_table" as cmp3 ON cmp1."Data_Shares" = cmp3."Id" WHERE cmp1."Data_Name" = 'Alex' AND cmp1."IsDelMark" = false AND cmp2."IsDelMark" = false AND cmp3."IsDelMark" = false '''
    assert filter_user_join.only(("Id", "Name"), ("Bonuses",)).get_sql() == result6

    result7 = '''SELECT cmp1."Id" as "Id", cmp1."Data_Name" as "Name", cmp1."Data_Email" as "Email", cmp1."Data_Account" as "Account", cmp1."Data_IsActive" as "IsActive", cmp1."Data_Inviter" as "Inviter", cmp1."Data_Age" as "Age", cmp1."Data_Shares" as "Shares", cmp2."Id" as "cmp2_Id", cmp2."Data_Bonuses" as "Bonuses", cmp2."Data_IsActual" as "IsActual", cmp2."Data_MainAccount" as "MainAccount", cmp2."Data_PremiumAccount" as "PremiumAccount", cmp2."Data_PromotionalAccount" as "PromotionalAccount", cmp3."Id" as "cmp3_Id", cmp3."Data_SharesCount" as "SharesCount" FROM "user_table" as cmp1 INNER JOIN "account_table" as cmp2 ON cmp1."Data_Account" = cmp2."Id" INNER JOIN "shares_table" as cmp3 ON cmp1."Data_Shares" = cmp3."Id" WHERE cmp1."IsDelMark" = false AND cmp2."IsDelMark" = false AND cmp3."IsDelMark" = false  LIMIT 5'''
    assert User().join().limit(5).get_sql() == result7

    result8 = '''SELECT cmp1."Id" as "Id", cmp1."Data_Name" as "Name", cmp1."Data_Email" as "Email", cmp1."Data_Account" as "Account", cmp1."Data_IsActive" as "IsActive", cmp1."Data_Inviter" as "Inviter", cmp1."Data_Age" as "Age", cmp1."Data_Shares" as "Shares", cmp2."Id" as "cmp2_Id", cmp2."Data_Bonuses" as "Bonuses", cmp2."Data_IsActual" as "IsActual", cmp2."Data_MainAccount" as "MainAccount", cmp2."Data_PremiumAccount" as "PremiumAccount", cmp2."Data_PromotionalAccount" as "PromotionalAccount", cmp3."Id" as "cmp3_Id", cmp3."Data_SharesCount" as "SharesCount" FROM "user_table" as cmp1 INNER JOIN "account_table" as cmp2 ON cmp1."Data_Account" = cmp2."Id" INNER JOIN "shares_table" as cmp3 ON cmp1."Data_Shares" = cmp3."Id" WHERE cmp1."IsDelMark" = false AND cmp2."IsDelMark" = false AND cmp3."IsDelMark" = false  ORDER BY "Data_Name" ASC'''
